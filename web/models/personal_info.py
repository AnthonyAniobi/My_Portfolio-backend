...
class PersonalInfo(models.Model):
    ...
    phone_line1 = models.IntegerField(max_length=12, verbose_name='first phone number')
    phone_line2 = models.IntegerField(max_length=12, verbose_name='second phone number')
